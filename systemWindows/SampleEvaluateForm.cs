...
{
    public partial class SampleEvaluateForm : Form
    {
        public SampleEvaluateForm()
        {
            InitializeComponent();
        ...
        private void saveSampleEvaluate_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/抽样评估法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findSampleEvaluateSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awaySampleEvaluate_Click(object sender, EventArgs e)
        {
        ...
        private void SampleEvaluateForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "sampleEvaluate.xlsx";
