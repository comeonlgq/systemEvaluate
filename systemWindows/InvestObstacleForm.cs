...
{
    public partial class InvestObstacleForm : Form
    {
        public InvestObstacleForm()
        {
            InitializeComponent();
        ...
        private void saveInvestObstacle_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/投资障碍分析法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findInvestObstacleSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayInvestObstacle_Click(object sender, EventArgs e)
        {
        ...
        private void InvestObstacleForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "investObstacleAnalysis.xlsx";
