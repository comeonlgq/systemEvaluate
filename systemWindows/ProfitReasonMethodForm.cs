...
{
    public partial class ProfitReasonMethodForm : Form
    {
        public ProfitReasonMethodForm()
        {
            InitializeComponent();
        ...
        private void saveProfitReson_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/利润因素分析法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findProfitResonSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayProfitReason_Click(object sender, EventArgs e)
        {
        ...
        private void ProfitReasonMethodForm_Load(object sender, EventArgs e)
        {
            //string strConn;
            //string fileName = "profitAnalysis.xlsx";
