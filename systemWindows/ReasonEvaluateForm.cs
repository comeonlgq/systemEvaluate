...
{
    public partial class ReasonEvaluateForm : Form
    {
        public ReasonEvaluateForm()
        {
            InitializeComponent();
        ...
        private void saveReasonEvaluate_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/要素评价分类法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findResonEvaluateSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayReasonEvaluate_Click(object sender, EventArgs e)
        {
        ...
        private void ReasonEvaluateForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "reasonEvaluate.xlsx";
