...
{
    public partial class DynamicMethodForm : Form
    {
        public DynamicMethodForm()
        {
            InitializeComponent();
        ...
        private void saveDynamicMethod_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/动态分析法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findDynamicMethodSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayDynamicMethod_Click(object sender, EventArgs e)
        {
        ...
        private void DynamicMethodForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "dynamicAnalysis.xlsx";
