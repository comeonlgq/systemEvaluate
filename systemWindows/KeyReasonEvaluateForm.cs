...
{
    public partial class KeyReasonEvaluateForm : Form
    {
        public KeyReasonEvaluateForm()
        {
            InitializeComponent();
        ...
        private void saveKeyReasonEva_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/关键因素评估法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findKeyReasonEvalSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayKeyReasonEva_Click(object sender, EventArgs e)
        {
        ...
        private void KeyReasonEvaluateForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "keyReasonAnalysis.xlsx";
