...
{
    public partial class MultiReasonResolveForm : Form
    {
        public MultiReasonResolveForm()
        {
            InitializeComponent();
        ...
        private void saveMutiReasonResolve_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/多因素加权分析法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findMultiReasonResolveSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayMultiReasonResolve_Click(object sender, EventArgs e)
        {
        ...
        private void MultiReasonResolveForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "multiReasonAnalysis.xlsx";
