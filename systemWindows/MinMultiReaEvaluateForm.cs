...
{
    public partial class MinMultiReaEvaluateForm : Form
    {
        public MinMultiReaEvaluateForm()
        {
            InitializeComponent();
        ...
        private void saveMinMultiReason_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/闵式多因素评估法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findMinMultiReasonSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void awayMinMultiReason_Click(object sender, EventArgs e)
        {
        ...
        private void MinMultiReaEvaluateForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "minMultiAnalysis.xlsx";
