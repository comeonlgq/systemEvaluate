...
{
    public partial class GradeEvaluateMethodForm : Form
    {
        public GradeEvaluateMethodForm()
        {
            InitializeComponent();
        ...
        private void GradeEvaluateMethodForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "gradeEvaluate.xlsx";
