...
{
    public partial class GreyCompareForm : Form
    {
        public GreyCompareForm()
        {
            InitializeComponent();
        ...
        private void awayGreyCompare_Click(object sender, EventArgs e)
        {
        ...
        private void saveGreyCompare_Click(object sender, EventArgs e)
        {
            ...
            bit.Save("F:/评价方法/灰色对比分析法.jpg");//默认保存格式为PNG，保存成jpg格式质量不是很好
        }

        private void findGreyCompareSource_Click(object sender, EventArgs e)
        {
            //当用户点击了人工选择按钮时
        ...
        private void GreyCompareForm_Load(object sender, EventArgs e)
        {
            string strConn;
            string fileName = "greyCompareAnalysis.xlsx";
